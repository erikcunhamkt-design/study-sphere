...
function EstudarPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Estudar"
        description="Escolha um método de estudo para começar uma sessão."
      />
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {METHODS.map((m) => (
          <button
            ...
            className="flex flex-col items-start gap-2 rounded-xl border border-border bg-surface/60 p-4 text-left transition-colors hover:border-primary/40 hover:bg-surface"
          >
