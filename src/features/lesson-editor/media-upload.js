...
export function validateMediaFile(file) {
    ...
    if (!category) {
        throw new MediaValidationError(`Tipo de arquivo não permitido (${file.type || "desconhecido"}).`);
    }
...
export function buildMediaPath(userId, lessonId, fileName) {
 ...
 */
export function createMediaUploader(userId, lessonId) {
    return async function uploadMedia(file) {
